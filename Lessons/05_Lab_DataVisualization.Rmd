...
ex1 <- ggplot(subset(PeterPaul.chem.nutrients, depth == 0), aes(x = daynum, y = temperature_C, color = year4)) + 
...
ex2 <- ggplot(PeterPaul.chem.nutrients) +
...
ggplot(EPAair) + 
  geom_point(aes(x = PM2.5, y = Ozone, color = meanLat),alpha = 0.5)+
