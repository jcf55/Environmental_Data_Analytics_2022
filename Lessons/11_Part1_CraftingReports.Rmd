...
```{r table building, echo=FALSE, fig.align = 'left', fig.cap = 'Summary of Total N'}
...
```{r total N display, echo = FALSE, fig.align = 'left', fig.cap = 'Summary of Total N'}

```

```{r total P display, echo = FALSE, fig.align = 'left', fig.cap = 'Summary of Total P'}
...
*insert paragraph about findings

***

*insert paragraph about next steps and questions
