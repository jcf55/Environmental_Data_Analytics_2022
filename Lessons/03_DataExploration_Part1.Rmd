...
> Answer: it shows the packages that have been uploaded along with anything else that is included 
...
=======
USGS.flow.data <- read.csv("../Data/Raw/USGS_Site02085000_Flow_Raw.csv")
>>>>>>> 531661e98d9511b746211a46dfe5bc327d2059fa
...
write.csv(USGS.flow.data, file = "./Data/Processed/USGS_Site02085000_Flow_data_complete.csv", row.names=FALSE)
