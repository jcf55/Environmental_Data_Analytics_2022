...
>  There is a significant negative correlation between irradiance and depth. There are lower light levels at higher depths. The model explains about 31% of the total variance in irradience.
...
```{r, fig.height = 3, fig.width = 4}
#we want to take the log of this data set so we have to remove 0s
...
#use the scale_y_log to get the relationship in straight line
irradiancebydepth2 <- 
  ggplot(PeterPaul.chem.nutrients, aes(x = depth, y = irradianceWater)) +
